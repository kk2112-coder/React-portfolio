...
function Contact() {
  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-[#050816] text-white">
      ...
      <footer className="border-t border-white/10 bg-black/20 px-5 py-14">
        ...
        <div className="mx-auto max-w-7xl">
          ...
          <div className="grid gap-10 md:grid-cols-2 lg:grid-cols-4">
            ...
            <div>
              ...
              <p className="mt-2 bg-gradient-to-r from-cyan-400 to-purple-400 bg-clip-text font-medium text-transparent">
            ...
            <div>
              ...
              <div className="mt-5 space-y-4 text-sm">
                ...
                <a
                  href="mailto:krishankantrajput2112@gmail.com"
                  className="flex items-start gap-3 break-all text-slate-400 transition hover:text-cyan-400"
                >
                  <MailIcon size={17} />
                  <span>
                    krishankantrajput2112@gmail.com
          ...
          {/* Footer Bottom */}
          <div className="mt-12 flex flex-col justify-between gap-4 border-t border-white/10 pt-6 text-sm text-slate-500 md:flex-row">

            <p>
              © {new Date().getFullYear()} Krishan Kant. All rights reserved.
            </p>
